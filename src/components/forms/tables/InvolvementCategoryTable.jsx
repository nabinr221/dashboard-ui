...
const InvolvementCategoryTable = ({ data, refetchData }) => {
  const apiUrl = `${import.meta.env.VITE_APP_API_URL}/involvement/categories`;
            ...
            <tr key={index}>
              ...
              <td className="whitespace-wrap px-12 py-4 flex items-center justify-center gap-3">
                <div className="text-sm text-gray-900 ">
                  <ToolTip text="edit">
                    <Link to={`/involvement-category/edit/${involveCat?._id}`}>
                ...
                <div className="text-sm text-gray-700">
                  <ToolTip text="delete">
                    <span
                      onClick={() => openModal(involveCat._id)}
...
export default InvolvementCategoryTable;
