...
const SizeTable = ({ data, refetchData }) => {
  const apiUrl = `${import.meta.env.VITE_APP_API_URL}/colors`;
  ...
  return (
    <TableContainer>
      <table className=' w-full sm:w-[50rem] divide-y divide-gray-200'>
