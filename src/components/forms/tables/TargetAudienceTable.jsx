...
const TargetAudienceTable = ({ data, refetchData }) => {
  const apiUrl = `${import.meta.env.VITE_APP_API_URL}/target-audiences`;
  console.log(data, "thiasdfasdfsa");
            ...
            <tr key={index}>
              ...
              <td className='whitespace-wrap px-12 w-full py-6 flex items-center justify-center gap-3'>
                <div className='text-sm text-gray-900 '>
                  <ToolTip text='edit'>
                    <Link to={`/target-audiences/edit/${item.id}`}>
