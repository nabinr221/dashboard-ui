...
const ProductCatTable = ({ data, refetchData }) => {
  const apiUrl = `${import.meta.env.VITE_APP_API_URL}/product-categories`;
  ...
  return (
    <TableContainer>
      <table className=' w-[50rem] divide-y divide-gray-200'>
            ...
            <tr key={index}>
              ...
              <td className='whitespace-wrap px-12 w-full py-6 flex items-center justify-center gap-3'>
                <div className='text-sm text-gray-900 '>
                  <ToolTip text='edit'>
                    <Link to={`/product-categories/edit/${item.id}`}>
