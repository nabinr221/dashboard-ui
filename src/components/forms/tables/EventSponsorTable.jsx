...
const EventSponsorTable = ({ data, refetchData }) => {
  const apiUrl = `${import.meta.env.VITE_APP_API_URL}/event-sponsors`;
            ...
            <tr key={index}>
              ...
              <td className='whitespace-wrap px-12 py-4 flex items-center justify-center gap-3'>
                <div className='text-sm text-gray-900 '>
                  <ToolTip text='edit'>
                    <Link to={`/event-sponsors/edit/${item.id}`}>
...
EventSponsorTable.propTypes = {
  data: PropTypes.array.isRequired,
  refetchData: PropTypes.func.isRequired,
};
export default EventSponsorTable;
