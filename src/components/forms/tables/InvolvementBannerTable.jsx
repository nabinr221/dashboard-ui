...
const InvolvementBannerTable = ({ data, refetchData }) => {
  const apiUrl = `${import.meta.env.VITE_APP_API_URL}/involvement/banners`;
    ...
    <TableContainer>
      <table className='min-w-full divide-y divide-gray-200'>
        ...
        <tbody className='divide-y divide-gray-200 bg-white'>
          {newData?.map((involveBanner, index) => (
            <tr key={index}>
              ...
              <td className='whitespace-wrap px-12 w-full py-6 flex items-center justify-center gap-3'>
                ...
                <div className='text-sm text-gray-700'>
                  <ToolTip text='delete'>
                    <span
                      onClick={() => openModal(involveBanner._id)}
...
export default InvolvementBannerTable;
