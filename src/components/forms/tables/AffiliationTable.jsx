...
const AffiliationTable = ({ data, refetchData }) => {
  const [deleteItemId, setDeleteItemId] = useState(null);
  const apiUrl = `${import.meta.env.VITE_APP_API_URL}/affiliations`;
      ...
      <table className='min-w-full divide-y divide-gray-200'>
        <thead className='bg-gray-50 capitalize font-bold '>
          <tr>
            <th
              scope='col'
              className='px-4 py-3.5  text-sm text-left  text-gray-700'
            >
              <span>SN</span>
            </th>
            ...
            <th
              scope='col'
              className='px-6 py-3.5 text-sm text-center text-gray-700'
            >
              Image
            </th>
            <th
            ...
            <th
              scope='col'
              className='px-12 py-3.5 text-sm text-left text-gray-700'
            >
              Date
            </th>
            ...
            <tr key={index}>
              ...
              <td className='whitespace-wrap px-12 py-4 flex items-center justify-center gap-3'>
                <div className='text-sm text-gray-900 '>
                  <ToolTip text='edit'>
                    <Link to={`/affiliations/edit/${affiliation._id}`}>
                ...
                <div className='text-sm text-gray-700'>
                  <ToolTip text='delete'>
                    <span
                      onClick={() => openModal(affiliation._id)}
